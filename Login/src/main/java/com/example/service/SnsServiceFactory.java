...
public class SnsServiceFactory {
	...
	protected OAuth20Service naver() {
		return new ServiceBuilder()
					.apiKey("Bc2zvL52e8sCG5i1R9K1")
					.apiSecret("8ZI4NtryKk")
					.callback("http://192.168.0.10:8080/callback")
					.state(STATE)
					.build(NaverLoginApi.getInstance());
	}
	
	protected OAuth20Service facebook() {
		return new ServiceBuilder()
